...
opcion = prompt(nombre + " te contamos que por esta semana, ¡Tenemos el 15% de descuento en el precio final de tu pedido! Estas son nuestras opciones: \n" 
...
precioParcial = pedido(opcion, cantidad);

console.log("Este es tu precio parcial: "+ precioParcial);

const resta = (a,b) => a - b;
const descuento = (d) => d * 0.15;

precioDescuento = descuento(precioParcial);

console.log("Este es tu descuento del 15%: "+ precioDescuento);


precioFinal = resta(precioParcial,precioDescuento);
